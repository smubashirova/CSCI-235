...
*/
bool Dish::operator==(const Dish& right)const{
    return (this->name_ == right.name_ &&
            this->cuisine_type_ == right.cuisine_type_ &&
            this->prep_time_ == right.prep_time_ &&
            this->price_ == right.price_);
}
